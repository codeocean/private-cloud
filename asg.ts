...
export const workersUtilizationScaleOutPolicy = new aws.autoscaling.Policy("workers-utilization-scale-out", {
...
export const workersUtilizationScaleInPolicy = new aws.autoscaling.Policy("workers-utilization-scale-in", {
    adjustmentType: "ChangeInCapacity",
    autoscalingGroupName: workersAsg.name,
    policyType: "StepScaling",
    stepAdjustments: [{
